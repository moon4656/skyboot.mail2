#!/usr/bin/env python3
"""
모든 사용자의 패스워드를 'test'로 일괄 변경하는 스크립트 (자동 실행 버전)
...
def reset_all_passwords_auto():
    """
    모든 사용자의 패스워드를 'test'로 변경합니다. (자동 실행)
    """
    print("=" * 80)
    print("⚠️  모든 사용자 패스워드 일괄 변경 작업 (자동 실행)")
    print("=" * 80)
    print("🔒 새 패스워드: 'test'")
